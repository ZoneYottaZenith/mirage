...
<p align="center">
  <b>基于 ChatGPT-Image-2.5 的自托管 AI 图像生成平台</b><br>
...
**幻象工坊（UCanTech）** 是一个可以完全自托管的 AI 图像生成平台，默认驱动 **ChatGPT-Image-2.5** 模型。它以「无限画布」为核心交互形态，把文生图、图生图、版本管理、本地历史整合在一个无需注册即可上手的工作台里；同时提供一套**高度可定制的管理后台**，让运营者可以自由接入任意兼容 OpenAI Images API 的中转站，独立控制模型、价格、额度与公告。

> **在线体验**：<https://mirage.ucan.asia>
